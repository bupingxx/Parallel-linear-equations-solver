/* File:      gauss3.cpp
 *
 * Compile:   mpiCC -g -Wall -fopenmp -o gauss3 gauss3.cpp
 *
 * Run:       mpiexec -n <num_proc> ./gauss3 <n> <num_threads> <ToPrint>
 * Note:      N = the num of formulas
 *            n should be evenly divided by num_proc and num_proc*num_threads
 *
 * Input:     None
 * Output:    The elapsed times for gauss using MPI + OpenMP
 *
 */
